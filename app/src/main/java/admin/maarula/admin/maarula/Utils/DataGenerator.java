...
public class DataGenerator {
    ...
    public static List<UpcomingLectures> getNewsData(Context ctx, int count) {

        List<UpcomingLectures> items = new ArrayList<>();
        ...
        for (int i = 0; i < count; i++) {
            UpcomingLectures obj = new UpcomingLectures();
